...
-- Definir Widgets adicionales
local search = wibox.widget {
    wibox.widget {
        markup = "<span foreground='".. beautiful.blue .."'></span>",
        font = beautiful.iconfont .. "20",
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox = awful.wibox({ position = "top", width = '100%', height = 36, screen = s, stretch = false, margins = 0, bg = beautiful.black })
    s.mywibox.y = 0
